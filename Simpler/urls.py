...
from SimplerApp.views import index, csimpler, question, post, makesimpler, register, user_login, user_logout, addpost, define, addanswer, requestbyuser, postreq, getUserProfile, follow
