...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Post.levels_simplified'
        db.delete_column(u'SimplerApp_post', 'levels_simplified')


    def backwards(self, orm):
        # Adding field 'Post.levels_simplified'
        db.add_column(u'SimplerApp_post', 'levels_simplified',
