...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Simpler.highlightq_id'
        db.delete_column(u'SimplerApp_simpler', 'highlightq_id')

        # Adding field 'highlightq.answers'
        db.add_column(u'SimplerApp_highlightq', 'answers',
                      self.gf('django.db.models.fields.CharField')(default='Level-1', max_length=10000000),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Simpler.highlightq_id'
        db.add_column(u'SimplerApp_simpler', 'highlightq_id',
                      self.gf('django.db.models.fields.IntegerField')(default=0, max_length=1000000000000, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'highlightq.answers'
        db.delete_column(u'SimplerApp_highlightq', 'answers')
    ...
    models = {
        ...
        u'SimplerApp.highlightq': {
            ...
            'answers': ('django.db.models.fields.CharField', [], {'default': "'Level-1'", 'max_length': '10000000'}),
