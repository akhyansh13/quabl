...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Simpler.parent_list'
        db.alter_column(u'SimplerApp_simpler', 'parent_list', self.gf('django.db.models.fields.CharField')(max_length=100000, null=True))

    def backwards(self, orm):

        # Changing field 'Simpler.parent_list'
        db.alter_column(u'SimplerApp_simpler', 'parent_list', self.gf('django.db.models.fields.CharField')(max_length=100000))
    ...
    models = {
        ...
        u'SimplerApp.simpler': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'parent_list': ('django.db.models.fields.CharField', [], {'default': "' '", 'max_length': '100000', 'null': 'True', 'blank': 'True'}),
