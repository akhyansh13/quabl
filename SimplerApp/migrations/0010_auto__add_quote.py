...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Quote'
        db.create_table(u'SimplerApp_quote', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('author', self.gf('django.db.models.fields.CharField')(max_length=1000000)),
            ('quote', self.gf('django.db.models.fields.CharField')(max_length=10000000)),
        ))
        db.send_create_signal(u'SimplerApp', ['Quote'])


    def backwards(self, orm):
        # Deleting model 'Quote'
        db.delete_table(u'SimplerApp_quote')
