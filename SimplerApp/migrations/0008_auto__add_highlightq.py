...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'highlightq'
        db.create_table(u'SimplerApp_highlightq', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('highlight', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['SimplerApp.highlight'])),
            ('question', self.gf('django.db.models.fields.CharField')(max_length=10000000, null=True, blank=True)),
        ))
        db.send_create_signal(u'SimplerApp', ['highlightq'])


    def backwards(self, orm):
        # Deleting model 'highlightq'
        db.delete_table(u'SimplerApp_highlightq')
