...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'SimplerApp_simpler', 'highlightq_id',
                      self.gf('django.db.models.fields.IntegerField')(default=0, max_length=1000000000000),
                      keep_default=False)
    ...
    models = {
        ...
        u'SimplerApp.simpler': {
            ...
            'highlightq_id': ('django.db.models.fields.IntegerField', [], {'default': '0', 'max_length': '1000000000000'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
