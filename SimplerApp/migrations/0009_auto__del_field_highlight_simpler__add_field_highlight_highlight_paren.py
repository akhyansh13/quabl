...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'highlight.simpler'
        db.delete_column(u'SimplerApp_highlight', 'simpler_id')

        # Adding field 'highlight.highlight_parent'
        db.add_column(u'SimplerApp_highlight', 'highlight_parent',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'highlight_parent', null=True, to=orm['SimplerApp.Simpler']),
                      keep_default=False)

        # Adding field 'highlight.highlight_simpler'
        db.add_column(u'SimplerApp_highlight', 'highlight_simpler',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['SimplerApp.Simpler'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'highlight.simpler'
        raise RuntimeError("Cannot reverse this migration. 'highlight.simpler' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'highlight.simpler'
        db.add_column(u'SimplerApp_highlight', 'simpler',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['SimplerApp.Simpler']),
                      keep_default=False)

        # Deleting field 'highlight.highlight_parent'
        db.delete_column(u'SimplerApp_highlight', 'highlight_parent_id')

        # Deleting field 'highlight.highlight_simpler'
        db.delete_column(u'SimplerApp_highlight', 'highlight_simpler_id')
