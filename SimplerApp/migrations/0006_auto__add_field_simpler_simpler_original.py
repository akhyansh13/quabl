...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Simpler.simpler_original'
        db.add_column(u'SimplerApp_simpler', 'simpler_original',
                      self.gf('django.db.models.fields.CharField')(default=' ', max_length=10000000),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Simpler.simpler_original'
        db.delete_column(u'SimplerApp_simpler', 'simpler_original')
