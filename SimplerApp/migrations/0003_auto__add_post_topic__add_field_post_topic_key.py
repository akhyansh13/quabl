...
class Migration(SchemaMigration):
    ...
    models = {
        u'SimplerApp.post': {
            ...
            'topic': ('django.db.models.fields.CharField', [], {'default': "' '", 'max_length': '10000000'}),
            'topic_key': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['SimplerApp.post_topic']", 'null': 'True', 'blank': 'True'})
        },
        u'SimplerApp.post_topic': {
            'Meta': {'object_name': 'post_topic'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
