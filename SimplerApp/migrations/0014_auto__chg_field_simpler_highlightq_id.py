...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Simpler.highlightq_id'
        db.alter_column(u'SimplerApp_simpler', 'highlightq_id', self.gf('django.db.models.fields.IntegerField')(max_length=1000000000000, null=True))

    def backwards(self, orm):

        # Changing field 'Simpler.highlightq_id'
        db.alter_column(u'SimplerApp_simpler', 'highlightq_id', self.gf('django.db.models.fields.IntegerField')(max_length=1000000000000))
    ...
    models = {
        ...
        u'SimplerApp.simpler': {
            ...
            'highlightq_id': ('django.db.models.fields.IntegerField', [], {'default': '0', 'max_length': '1000000000000', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
