...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'SimplerApp_post', 'description',
                      self.gf('django.db.models.fields.CharField')(max_length=1000000000, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Post.description'
        db.delete_column(u'SimplerApp_post', 'description')
